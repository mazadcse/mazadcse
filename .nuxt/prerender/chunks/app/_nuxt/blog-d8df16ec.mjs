import { T as Title, M as Meta } from './components-2beab70c.mjs';
import { u as useServerSeoMeta, e as useRoute, _ as _export_sfc, b as __nuxt_component_0$2, a as __nuxt_component_1$2 } from '../server.mjs';
import { mergeProps, withCtx, createTextVNode, toDisplayString, useSSRContext, computed, unref, openBlock, createBlock, createVNode, createCommentVNode, Fragment, renderList } from 'file://C:/Users/mazad/OneDrive/Desktop/mazadcse/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderList } from 'file://C:/Users/mazad/OneDrive/Desktop/mazadcse/node_modules/vue/server-renderer/index.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (__props.coverImage) {
              _push2(`<div class="card-style w-0 md:w-1/3 hidden md:inline-block flex-shrink-0 min-h-full overflow-hidden mr-1 rounded-lg" data-v-5e08c507${_scopeId}>`);
              _push2(ssrRenderComponent(_component_nuxt_img, {
                format: "webp",
                loading: "lazy",
                src: __props.coverImage,
                alt: "Cover Image",
            ...
            _push2(`<div class="card-style flex flex-col justify-between py-2 px-4 flex-shrink-0 w-full md:w-[calc(66%-.25rem)] min-h-full" data-v-5e08c507${_scopeId}><h3 class="font-bold" data-v-5e08c507${_scopeId}>${ssrInterpolate(__props.blogTitle)}</h3><p class="text-xs text-slate-400 mt-[2px]" data-v-5e08c507${_scopeId}> Updated ${ssrInterpolate(unref(lastUpdateTime))} ${ssrInterpolate(__props.readTime ? `\u2022 ${__props.readTime}` : "")}</p><div class="my-1 mt-auto" data-v-5e08c507${_scopeId}><!--[-->`);
            ssrRenderList(__props.tags, (tag) => {
              _push2(`<span class="px-2 py-[.1rem] inline-block rounded-full font-medium font-mono text-xs mr-1 border border-slate-300 dark:border-slate-500 bg-slate-100 dark:bg-slate-600 text-slate-700 dark:text-slate-100" data-v-5e08c507${_scopeId}>${ssrInterpolate(tag)}</span>`);
            });
            _push2(`<!--]--></div></div>`);
          } else {
            return [
              __props.coverImage ? (openBlock(), createBlock("div", {
                key: 0,
              ...
              createVNode("div", { class: "card-style flex flex-col justify-between py-2 px-4 flex-shrink-0 w-full md:w-[calc(66%-.25rem)] min-h-full" }, [
                createVNode("h3", { class: "font-bold" }, toDisplayString(__props.blogTitle), 1),
                createVNode("p", { class: "text-xs text-slate-400 mt-[2px]" }, " Updated " + toDisplayString(unref(lastUpdateTime)) + " " + toDisplayString(__props.readTime ? `\u2022 ${__props.readTime}` : ""), 1),
                createVNode("div", { class: "my-1 mt-auto" }, [
...
_sfc_main$1.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/cards/AppBlogCard.vue");
  return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
const __nuxt_component_3 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-5e08c507"]]);
const _sfc_main = {
  __name: "blog",
  __ssrInlineRender: true,
  setup(__props) {
    const seoMeta = {
      title: "Dawit's Blog",
      description: "This page contains my articles on various software and web development topics.",
      image: "/og-image.png"
    };
    useServerSeoMeta({
      title: seoMeta.title,
    ...
    const blogPosts = [
      {
          ...
          "children": [
            {
              ...
              "children": [
                ...
                {
                  "type": "text",
                  "value": " in some significant ways."
                }
              ]
            },
            {
            ...
            },
            {
              ...
              "children": [
                {
                  "type": "text",
                  "value": "Modules are loaded directly from URLs and cached locally."
                }
              ]
            },
            {
              ...
              "props": {
                ...
                "code": 'import confetti from "https://esm.sh/canvas-confetti@1.6.0";\n',
                "language": "js",
                "meta": ""
              },
              "children": [
                          ...
                          "children": [
                            ...
                            },
                            {
                              ...
                              "children": [
                                {
                                  "type": "text",
                                  "value": '"https://esm.sh/canvas-confetti@1.6.0"'
                                }
                              ]
                            },
                            {
            ...
            },
            {
              ...
              "children": [
                {
                  "type": "text",
                  "value": "This allows decentralization of packages by removing reliance on "
                },
                {
                  "type": "element",
                  "tag": "a",
                ...
                {
                  "type": "text",
                  "value": " and enabling developers to self-host their packages."
                }
              ]
            },
            {
              ...
              "children": [
                {
                  "type": "text",
                  "value": "Consequently, this removes the need for "
                },
                {
                  "type": "element",
                  "tag": "code-inline",
                ...
                {
                  "type": "text",
                  "value": ", and allows programs to run in the browser since there is no reliance on build tools like webpack."
                }
              ]
            },
            {
            ...
            },
            {
              ...
              "children": [
                {
                  "type": "text",
                  "value": "Because code is executed in a sandbox, the Deno runtime has no access to the file system, and the network. Flags like "
                },
                {
                  "type": "element",
                  "tag": "code-inline",
                ...
                {
                  "type": "text",
                  "value": " can be used to explicitly enable access."
                }
              ]
            },
            {
              ...
              "children": [
                {
                  "type": "text",
                  "value": "In addition to the above features, Deno supports TypeScript out of the box, and has a built-in formatter for code similar to ESLint for Node.js."
                }
              ]
            },
            {
        ...
        "_type": "markdown",
        "_id": "content:blog:deno-vs-node.md",
        "_source": "content",
        "_file": "blog/deno-vs-node.md",
        "_extension": "md"
      },
      {
        "_path": "/blog/dns",
          ...
          "children": [
            ...
            },
            {
              ...
              "children": [
                {
                  "type": "text",
                  "value": "It is much easier for you to memorize the domain name of a service (e.g. "
                },
                {
                  "type": "element",
                  "tag": "a",
            ...
            },
            {
              ...
              "children": [
                {
                  "type": "text",
                  "value": "DNS servers can be any of these 4 categories:"
                }
              ]
            },
            {
              ...
              "children": [
                {
                  ...
                  "children": [
                    {
                      "type": "text",
                      "value": "Recursive nameserver (DNS Resolver)"
                    }
                  ]
                },
                {
                ...
                },
                {
                  ...
                  "children": [
                    {
                      "type": "text",
                      "value": "Top-level Domain (TLD) nameservers"
                    }
                  ]
                },
                {
                  ...
                  "children": [
                    {
                      "type": "text",
                      "value": "Authoritative nameservers"
                    }
                  ]
                }
              ]
            },
            {
              ...
              "children": [
                {
                  "type": "text",
                  "value": "Let's assume a user wants to visit "
                },
                {
                  "type": "element",
                  "tag": "a",
                ...
                {
                  "type": "text",
                  "value": " and types the URL in the bar."
                }
              ]
            },
            {
              ...
              "children": [
                {
                  ...
                  "children": [
                    {
                      "type": "text",
                      "value": "The computer searches for the associated IP address in the local DNS cache to see if this site has been recently retrieved. If it is found, the process ends here and the IP address gets returned."
                    }
                  ]
                },
                {
                  ...
                  "children": [
                    {
                      "type": "text",
                      "value": "If not found in the local cache, the computer continues to ask the DNS resolver from the Internet Service Provider (ISP) which has its own cache. Many customers of the ISP are likely using the same resolver, so popular services and domains will probably be cached. It looks for the mappings in the resolver's cache as well. If it's found, the process ends here and the IP address gets returned. Otherwise, it continues to the next stage."
                    }
                  ]
                },
                {
                ...
                },
                {
                  ...
                  "children": [
                    {
                      "type": "text",
                      "value": "The DNS resolver receives the info and stores in its local cache for future reference. Another customer wanting to navigate to "
                    },
                    {
                      "type": "element",
                      "tag": "a",
                    ...
                    {
                      "type": "text",
                      "value": " is spared this lookup process because of caching. But, cached records have expiration dates and need to be replaced with new copies by the resolver to ensure up-to-date information."
                    }
                  ]
                },
                {
                  ...
                  "children": [
                    {
                      "type": "text",
                      "value": "The record is returned to the client by the resolver. The client stores the record in its own cache. It then retrieves the IP address from the record and passes it to the browser, so the browser can open a connection and make the request to the web server with the site information."
                    }
                  ]
                }
              ]
              ...
              "children": [
                {
                  ...
                  "children": [
                    ...
                    {
                      "type": "text",
                      "value": ": In occasions where the query contains a subdomain (e.g. "
                    },
                    {
                      "type": "element",
                      "tag": "a",
                    ...
                    {
                      "type": "text",
                      "value": "), there will be an extra nameserver that gets added to the end of the sequence which is responsible for that subdomain ("
                    },
                    {
                      "type": "element",
                      "tag": "code-inline",
              ...
              "children": [
                {
                  ...
                  "props": {
                    ...
                    "src": "/content/dns.resolution.png"
                  },
                  "children": []
                }
              ]
            },
            {
              ...
              "children": [
                {
                  "type": "text",
                  "value": "All this process is performed whenever someone wants to visit a website, and it is completed in a matter of milliseconds."
                }
              ]
            },
            {
              ...
              "children": [
                {
                  ...
                  "children": [
                    {
                      "type": "text",
                      "value": "Originally Posted on "
                    },
                    {
                      "type": "element",
                      "tag": "a",
                      "props": {
                        "href": "https://iq.opengenus.org/domain-name-system-explained/",
                        "rel": [
                          "nofollow"
                        ]
                      },
          ...
          "children": [
            {
              ...
              "children": [
                {
                  "type": "text",
                  "value": "In this article, I will discuss how HTTP requests work behind the scenes."
                }
              ]
            },
            {
            ...
            },
            {
              ...
              "children": [
                ...
                {
                  "type": "text",
                  "value": " here refers to the computer asking for service by making requests \u2014 e.g. to make a search or to check news"
                }
              ]
            },
            {
              ...
              "children": [
                ...
                {
                  "type": "text",
                  "value": " is the computer, that is usually located somewhere else, holding the things necessary to provide those services. It is responsible for sending responses to requests."
                }
              ]
            },
            {
              ...
              "tag": "h2",
              "props": {
                "id": "how-actually-are-requests-made"
              },
              "children": [
                {
                  "type": "text",
                  "value": "How actually are requests made?"
                }
              ]
            },
            {
              ...
              "children": [
                {
                  "type": "text",
                  "value": "Requests on the web are made through a set of steps and make use of a protocol known as HTTP. HTTP stands for HyperText Transfer Protocol. It is used for communication between the client and the server(s). It is the foundation of the Internet. HTTP uses the URL typed into the browser to identify the resource wanted and to make a connection."
                }
              ]
            },
            {
              ...
              "children": [
                {
                  "type": "text",
                  "value": "When requesting a site, the URL looks something like this "
                },
                {
                  "type": "element",
                  "tag": "code-inline",
                ...
                {
                  "type": "text",
                  "value": ". Using the URL provided, the browser identifies the request needs to be made through "
                },
                {
                  "type": "element",
                  "tag": "code-inline",
                ...
                {
                  "type": "text",
                  "value": " and the domain name for the web address is "
                },
                {
                  "type": "element",
                  "tag": "code-inline",
            ...
            },
            {
              ...
              "children": [
                {
                  "type": "text",
                  "value": "Request messages are exchanged between the client and server to fulfill that request, and they usually follow a similar format. They contain 4 components: "
                },
                {
                  "type": "element",
                  "tag": "strong",
                ...
                {
                  "type": "text",
                  "value": " to indicate the end of headers and an optional "
                },
                {
                  "type": "element",
                  "tag": "strong",
            ...
            },
            {
              ...
              "children": [
                {
                  "type": "text",
                  "value": "Below is an example of a typical GET request message. This is similar to what you would usually see if you open the Network tab from your browser Dev Tools."
                }
              ]
            },
            {
                          ...
                          "children": [
                            {
                              ...
                              "children": [
                                {
                                  "type": "text",
                                  "value": "GET /tag/algorithm HTTP/1.1\n"
                                }
                              ]
                            }
                          ]
                          ...
                          "children": [
                            {
                              ...
                              "children": [
                                {
                                  "type": "text",
                                  "value": "User-Agent: Mozilla/5.0 (Windows NT) Gecko/20100101 Firefox/73.0\n"
                                }
                              ]
                            }
                          ]
            ...
            },
            {
              ...
              "children": [
                {
                  "type": "text",
                  "value": "This is the first line of a message describing the requests to be implemented."
                }
              ]
            },
            {
              ...
              "children": [
                {
                  "type": "text",
                  "value": "For a request, this line contains these values separated by a space: method, request URI and HTTP version followed by a new line."
                }
              ]
            },
            {
              ...
              "children": [
                {
                  ...
                  "children": [
                    ...
                    {
                      "type": "text",
                      "value": " indicates the type of request to be made and common values include: GET, HEAD, POST, PUT, and DELETE."
                    }
                  ]
                },
                {
                  ...
                  "children": [
                    ...
                    {
                      "type": "text",
                      "value": " is the version of HTTP, usually HTTP/1.0 or HTTP/1.1."
                    }
                  ]
                },
                {
                  ...
                  "children": [
                    ...
                    {
                      "type": "text",
                      "value": " is the path to the resource upon which the request is to be made. It can be either an absolute URI or a relative URI."
                    }
                  ]
                }
              ]
            },
            {
              ...
              "children": [
                {
                  "type": "text",
                  "value": "Examples are shown below."
                }
              ]
            },
            {
              ...
              "children": [
                {
                  ...
                  "children": [
                    ...
                    {
                      "type": "text",
                      "value": " - is a relative URI meaning root path. We are not navigating any further. We have identified the host, and we are making request on the root."
                    }
                  ]
                }
              ]
                  ...
                  "children": [
                    {
                      ...
                      "children": [
                        {
                          "type": "text",
                          "value": "https://iq.opengenus.org/tag/algorithm"
                        }
                      ]
                    },
                    {
                      "type": "text",
                      "value": " - is the absolute URI."
                    }
                  ]
                }
              ]
            },
            {
              ...
              "props": {
                ...
                "code": "GET https://iq.opengenus.org/tag/algorithm HTTP/1.1\n"
              },
              "children": [
                {
                  "type": "element",
                          ...
                          "children": [
                            {
                              ...
                              "children": [
                                {
                                  "type": "text",
                                  "value": "GET https://iq.opengenus.org/tag/algorithm HTTP/1.1"
                                }
                              ]
                            }
                          ]
              ...
              "children": [
                {
                  ...
                  "children": [
                    ...
                    {
                      "type": "text",
                      "value": " - is a relative URI meaning we are navigating to this path from the host or root path which is "
                    },
                    {
                      "type": "element",
                      "tag": "code-inline",
            ...
            },
            {
              ...
              "children": [
                ...
                {
                  "type": "text",
                  "value": ", the template is composed of these values separated by a space: "
                },
                {
                  "type": "element",
                  "tag": "strong",
              ...
              "children": [
                ...
                },
                {
                  ...
                  "children": [
                    ...
                    {
                      "type": "text",
                      "value": " is a 3 digit integer indicating the status of our response. These can be in any one of 5 classes:"
                    },
                    {
                      "type": "element",
                      "tag": "ul",
                ...
                },
                {
                  ...
                  "children": [
                    ...
                    {
                      "type": "text",
                      "value": " follows the status code and is a short summary of the status of the response."
                    }
                  ]
                }
              ]
            ...
            },
            {
              ...
              "children": [
                {
                  "type": "text",
                  "value": "Headers follow the start line, and they allow the client to pass additional information about the request or the client itself to the server, or they allow the server to pass additional information about the response to the client. They usually appear as key-value pairs. Headers can be:"
                }
              ]
            },
            {
                  ...
                  "children": [
                    {
                      ...
                      "children": [
                        {
                          "type": "text",
                          "value": "General headers"
                        }
                      ]
                    },
                    {
                      "type": "text",
                      "value": " - applicable to both requests and responses."
                    }
                  ]
                },
                {
                  ...
                  "children": [
                    ...
                    {
                      "type": "text",
                      "value": " - applicable to only requests sent by the client."
                    }
                  ]
                },
                {
                  ...
                  "children": [
                    ...
                    {
                      "type": "text",
                      "value": " - applicable to only responses sent by the server."
                    }
                  ]
                },
                {
                  ...
                  "children": [
                    ...
                    {
                      "type": "text",
                      "value": " - applicable to message body (if there is any)."
                    }
                  ]
                }
              ]
            },
            {
              ...
              "children": [
                {
                  "type": "text",
                  "value": "Some common headers are listed below:"
                }
              ]
            },
            {
            ...
            },
            {
              ...
              "children": [
                {
                  "type": "text",
                  "value": "Header fields ensure requests and responses are made just the way the client and server want. In other words, header fields are a means of communication between a client and a server with specific details given to fulfill the request."
                }
              ]
            },
            {
              ...
              "children": [
                ...
                {
                  "type": "text",
                  "value": " is one method which makes this whole process more convenient for the devices involved. It improves performance by removing the need for a client to send any or some requests, or the need for a server to send back any or some responses. It does so by using the "
                },
                {
                  "type": "element",
                  "tag": "code-inline",
            ...
            },
            {
              ...
              "children": [
                ...
                {
                  "type": "text",
                  "value": " are important in enforcing the data types sent to a server or sent back from a server are in alignment with each other. Header fields like "
                },
                {
                  "type": "element",
                  "tag": "code-inline",
                ...
                {
                  "type": "text",
                  "value": " are a means of communicating the types of files and documents involved in a request."
                }
              ]
            },
            {
              ...
              "children": [
                ...
                {
                  "type": "text",
                  "value": " like the type of hardware and versions of software are also important in delivering an optimized experience. The "
                },
                {
                  "type": "element",
                  "tag": "code-inline",
            ...
            },
            {
              ...
              "children": [
                {
                  "type": "text",
                  "value": "If our message has a body, it is preceded by an empty line which come after the headers. The empty line indicates the end of header fields. The message body carries actual data for a request from a client (e.g. form data when authenticating) or a response from a server (e.g. files and images).\nA simple line of code can be passed after the empty line as the body of a request or a response. The following two examples show server responses: when the requested resource is found and when it's not found."
                }
              ]
            },
            {
                          ...
                          "children": [
                            {
                              ...
                              "children": [
                                {
                                  "type": "text",
                                  "value": "        <p>Sorry friend, the requested resource wasn't found</p>\n"
                                }
                              ]
                            }
                          ]
            ...
            },
            {
              ...
              "children": [
                {
                  "type": "text",
                  "value": "To get a closer look at requests in your browser, you can navigate to 'Network' tab of your browser's Developer Tools, or just hit "
                },
                {
                  "type": "element",
                  "tag": "code-inline",
                ...
                {
                  "type": "text",
                  "value": " on Windows and Linux. Type the URL to any website and see all the requests and responses made. Usually there are several requests and responses made. Each request fetching a single file that is a component of the website to be rendered."
                }
              ]
            },
            {
              ...
              "children": [
                {
                  ...
                  "tag": "img",
                  "props": {
                    "alt": "Developer Tools: Network Tab (Firefox)",
                    "src": "/content/http.network-tab.png"
                  },
                  "children": []
                }
              ]
            },
            {
              ...
              "children": [
                {
                  "type": "text",
                  "value": "The above image shows a detailed look at what goes on behind the scenes when navigating to the "
                },
                {
                  "type": "element",
                  "tag": "a",
            ...
            },
            {
              ...
              "tag": "h2",
              "props": {
                "id": "a-few-more-examples"
              },
              "children": [
                {
                  "type": "text",
                  "value": "A few more examples"
                }
              ]
            },
            {
              ...
              "children": [
                {
                  "type": "text",
                  "value": "In this one, we are using "
                },
                {
                  "type": "element",
                  "tag": "strong",
                ...
                {
                  "type": "text",
                  "value": " method to make searches on DuckDuckGo. The request looks like this:"
                }
              ]
            },
            {
              ...
              "props": {
                ...
                "code": "POST https://duckduckgo.com HTTP/1.1\nAccept: text/html\nAccept-Language: en-US\nConnection: keep-alive\nContent-Length: 18\nContent-Type: application/x-www-form-urlencoded\nUser-Agent: Mozilla/5.0 (Windows NT) Gecko/20100101 Firefox/73.0\n\nq=opengenus\n"
              },
              "children": [
                {
                  "type": "element",
                          ...
                          "children": [
                            {
                              ...
                              "children": [
                                {
                                  "type": "text",
                                  "value": "POST https://duckduckgo.com HTTP/1.1\n"
                                }
                              ]
                            }
                          ]
            ...
            },
            {
              ...
              "children": [
                ...
                {
                  "type": "text",
                  "value": " method is very similar to POST but it is used to update resources."
                }
              ]
            },
            {
                          ...
                          "children": [
                            {
                              ...
                              "children": [
                                {
                                  "type": "text",
                                  "value": "PUT /update.html HTTP/1.1\n"
                                }
                              ]
                            }
                          ]
            ...
            },
            {
              ...
              "children": [
                ...
                {
                  "type": "text",
                  "value": " method can be used to delete a given resource."
                }
              ]
            },
            {
              ...
              "props": {
                ...
                "code": "DELETE /resource.html HTTP/1.1\n"
              },
              "children": [
                {
                  "type": "element",
                          ...
                          "children": [
                            {
                              ...
                              "children": [
                                {
                                  "type": "text",
                                  "value": "DELETE /resource.html HTTP/1.1"
                                }
                              ]
                            }
                          ]
            ...
            },
            {
              ...
              "children": [
                {
                  "type": "text",
                  "value": "The server can send back a response notifying the client about the completion of the DELETE request."
                }
              ]
            },
            {
                          ...
                          "children": [
                            {
                              ...
                              "children": [
                                {
                                  "type": "text",
                                  "value": "    <h1>Resource successfully deleted.</h1>\n"
                                }
                              ]
                            }
                          ]
                  ...
                  "children": [
                    {
                      ...
                      "children": [
                        {
                          "type": "text",
                          "value": "HTTP - Mozilla Developer Network"
                        }
                      ]
                    }
                  ]
              ...
              "children": [
                {
                  ...
                  "children": [
                    ...
                    },
                    {
                      ...
                      "tag": "a",
                      "props": {
                        "href": "https://iq.opengenus.org/http-requests/",
                        "rel": [
                          "nofollow"
                        ]
                      },
          ...
          "toc": {
            ...
            "links": [
              ...
              },
              {
                "id": "how-actually-are-requests-made",
                "depth": 2,
                "text": "How actually are requests made?"
              },
              {
                "id": "a-few-more-examples",
                "depth": 2,
          ...
          "children": [
            {
              ...
              "children": [
                ...
                {
                  "type": "text",
                  "value": " is a protocol which is an improvement over HTTP and is the short form of "
                },
                {
                  "type": "element",
                  "tag": "strong",
                ...
                {
                  "type": "text",
                  "value": " (HTTP + SSL). In this article, we will look at the shortcomings of HTTP which lead to the development of HTTPS and some basic ideas behind HTTPS. It'll cover these sub topics:"
                }
              ]
            },
            {
            ...
            },
            {
              ...
              "children": [
                {
                  "type": "text",
                  "value": "As introduced in "
                },
                {
                  "type": "element",
                  "tag": "a",
                  "props": {
                    "href": "https://dev.to/oneminch/http-basics-nji",
                    "rel": [
                      "nofollow"
                    ]
                  },
                  "children": [
                    {
                      "type": "text",
                      "value": "this article about HTTP"
                    }
                  ]
                },
                {
                  "type": "text",
                  "value": ", HTTP is a protocol of the web that allows communication between devices. It is the technology behind the requests and responses made on the web. Once the client device has identified the server address, it works by opening a connection tunnel to the server, so the intended requests are made."
                }
              ]
            },
            {
            ...
            },
            {
              ...
              "children": [
                {
                  "type": "text",
                  "value": "Another drawback is that "
                },
                {
                  "type": "element",
                  "tag": "strong",
                  ...
                  "children": [
                    {
                      "type": "text",
                      "value": "someone on the network can manipulate the requests"
                    }
                  ]
                },
                {
                  "type": "text",
                  "value": ", so they can insert ads, or inject code to serve phishing sites or just steal user information. In HTTP, if you visit a site, lets say, a shopping site, there is no way to actually verify that the site that you are visiting is the site you wanted to visit. In other words, the website you get if you wanted to go to "
                },
                {
                  "type": "element",
                  "tag": "a",
                ...
                {
                  "type": "text",
                  "value": ", might not be the actual website. It can be a forged site injected by some entity along the network to trick users into giving away personal information. All these problems make plain HTTP a less ideal way to communicate on the web."
                }
              ]
            },
            {
              ...
              "tag": "h2",
              "props": {
                "id": "the-solution-https"
              },
              "children": [
                {
                  "type": "text",
                  "value": "The Solution: HTTPS"
                }
              ]
            },
            {
            ...
            },
            {
              ...
              "children": [
                ...
                {
                  "type": "text",
                  "value": " which is a unique cryptographic key and have it signed by an entity known as a "
                },
                {
                  "type": "element",
                  "tag": "em",
                ...
                {
                  "type": "text",
                  "value": ". The administrator of the website can ask the "
                },
                {
                  "type": "element",
                  "tag": "em",
                ...
                {
                  "type": "text",
                  "value": ". In other words, a certificate is a way of saying if a browser is opened at "
                },
                {
                  "type": "element",
                  "tag": "a",
                ...
                {
                  "type": "text",
                  "value": ", then it is really on the official site for DuckDuckGo."
                }
              ]
            },
            {
            ...
            },
            {
              ...
              "children": [
                {
                  "type": "text",
                  "value": "This video explains well how SSL encryption works."
                }
              ]
            },
            {
              ...
              "props": {
                "title": "vimeo-player",
                "src": "https://player.vimeo.com/video/239132801?h=4bbba48a70",
                "width": 640,
                "height": 360,
                "frameBorder": "0",
              ...
              "children": [
                {
                  "type": "text",
                  "value": "DigiCert - # What is SSL and Why Does It Matter?"
                }
              ]
            },
            {
            ...
            },
            {
              ...
              "children": [
                {
                  "type": "text",
                  "value": "However, HTTPS has its limitations. Domain names and IP addresses are not secure when using HTTPS. This is part of the reason why the use of VPNs is advised when using public wireless networks to mask IP addresses."
                }
              ]
            },
            {
              ...
              "children": [
                {
                  "type": "text",
                  "value": "HTTPS is becoming adopted by more and more websites every day. Modern browsers like Firefox and Chrome warn users if a website has an invalid certificate or if the connection is not secure (if it uses http:// instead of https://). They use a lock icon to the left of each URL to indicate if the site is authenticated and if it uses HTTPS. Latest versions of these browsers even ask twice before navigating to insecure sites. Tools like Firefox's built-in "
                },
                {
                  "type": "element",
                  "tag": "a",
                  "props": {
                    "href": "https://support.mozilla.org/en-US/kb/https-only-prefs",
                    "rel": [
                      "nofollow"
                    ]
                  },
                  "children": [
                    {
                      "type": "text",
                      "value": "HTTPS-Only Mode"
                    }
                  ]
                },
                {
                  "type": "text",
                  "value": " and extensions like "
                },
                {
                  "type": "element",
                  "tag": "a",
                  ...
                  "children": [
                    {
                      "type": "text",
                      "value": "HTTPS Everywhere"
                    }
                  ]
                },
                {
                  "type": "text",
                  "value": " work by rewriting insecure HTTP request to HTTPS. And with services like "
                },
                {
                  "type": "element",
                  "tag": "a",
                ...
                {
                  "type": "text",
                  "value": ", enabling HTTPS on sites is becoming more convenient."
                }
              ]
            },
            {
              ...
              "children": [
                {
                  ...
                  "children": [
                    ...
                    },
                    {
                      ...
                      "tag": "a",
                      "props": {
                        "href": "https://iq.opengenus.org/idea-behind-https/",
                        "rel": [
                          "nofollow"
                        ]
                      },
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_AppBlogCard = __nuxt_component_3;
      _push(`<main${ssrRenderAttrs(mergeProps({ id: "blog" }, _attrs))}>`);
      _push(ssrRenderComponent(_component_Title, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(seoMeta.title)}`);
          } else {
            return [
              createTextVNode(toDisplayString(seoMeta.title), 1)
            ];
          }
        }),
        _: 1
      ...
      _push(`<h1 class="text-3xl text-left font-bold mb-6">Blog</h1><section>`);
      {
        _push(`<!--[-->`);
        ssrRenderList(blogPosts, (blogPost) => {
          _push(ssrRenderComponent(_component_AppBlogCard, {
            key: blogPost._id,
            tags: blogPost.tags,
...
//# sourceMappingURL=blog-d8df16ec.mjs.map
