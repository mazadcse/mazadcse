...
import { u as useServerSeoMeta, e as useRoute } from '../server.mjs';
import { mergeProps, withCtx, createTextVNode, toDisplayString, useSSRContext } from 'file://C:/Users/mazad/OneDrive/Desktop/mazadcse/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate } from 'file://C:/Users/mazad/OneDrive/Desktop/mazadcse/node_modules/vue/server-renderer/index.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main${ssrRenderAttrs(mergeProps({ id: "contact" }, _attrs))}>`);
      ...
      _push(`<h1>Send me a message.</h1></main>`);
    };
  }
};
...
//# sourceMappingURL=contact-633bce2f.mjs.map
