globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file://C:/Users/mazad/OneDrive/Desktop/mazadcse/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join as join$1 } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseStatus, getRequestHeader, setResponseHeader, getRequestHeaders, getRequestHost, getRequestProtocol, getQuery as getQuery$1, setHeader, getCookie, createError, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler } from 'file://C:/Users/mazad/OneDrive/Desktop/mazadcse/node_modules/h3/dist/index.mjs';
...
import { parseURL, withoutBase, joinURL, getQuery, withQuery, hasProtocol, withHttps, withoutProtocol, withBase, withLeadingSlash, withoutTrailingSlash, isRelative } from 'file://C:/Users/mazad/OneDrive/Desktop/mazadcse/node_modules/ufo/dist/index.mjs';
...
import { extname, join } from 'file://C:/Users/mazad/OneDrive/Desktop/mazadcse/node_modules/pathe/dist/index.mjs';
...
import { preprocess } from 'file://C:/Users/mazad/OneDrive/Desktop/mazadcse/node_modules/micromark/dev/lib/preprocess.js';
import { postprocess } from 'file://C:/Users/mazad/OneDrive/Desktop/mazadcse/node_modules/micromark/dev/lib/postprocess.js';
...
import { markdownLineEnding, markdownSpace } from 'file://C:/Users/mazad/OneDrive/Desktop/mazadcse/node_modules/micromark-util-character/dev/index.js';
import { push, splice } from 'file://C:/Users/mazad/OneDrive/Desktop/mazadcse/node_modules/micromark-util-chunked/dev/index.js';
...
const _lazy_J7shT5 = () => Promise.resolve().then(function () { return contact$1; });
const _lazy_gHvn1h = () => Promise.resolve().then(function () { return picks$1; });
const _lazy_nGQwfz = () => Promise.resolve().then(function () { return renderer$1; });
...
const handlers = [
  ...
  { route: '/__nuxt_error', handler: _lazy_nGQwfz, lazy: true, middleware: false, method: undefined },
  ...
  { route: '/api/_content/cache.json', handler: _fuMGVk, lazy: false, middleware: false, method: "get" },
...
const picks = defineEventHandler(async () => {
  try {
    const picks = [
      {
...
const picks$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: picks
});
...
const getClientManifest = () => import('file://C:/Users/mazad/OneDrive/Desktop/mazadcse/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('file://C:/Users/mazad/OneDrive/Desktop/mazadcse/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
...
const _virtual__headStatic = {"headTags":"<meta charset=\"utf-8\">\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\">\n<meta http-equiv=\"X-UA-Compatible\" content=\"IE=edge\">\n<link rel=\"preconnect\" href=\"https://fonts.bunny.net\">\n<link rel=\"stylesheet\" href=\"https://fonts.bunny.net/css?family=roboto-mono:400,400i,500,600,700|inter:300,400,500,600,700,800\">\n<script>partytown = { debug: true, forward: [], lib: \"/~partytown/\" }</script>\n<script>/* Partytown 0.7.6 - MIT builder.io */\n!function(t,e,n,i,r,o,a,d,s,c,p,l){function u(){l||(l=1,\"/\"==(a=(o.lib||\"/~partytown/\")+(o.debug?\"debug/\":\"\"))[0]&&(s=e.querySelectorAll('script[type=\"text/partytown\"]'),i!=t?i.dispatchEvent(new CustomEvent(\"pt1\",{detail:t})):(d=setTimeout(f,1e4),e.addEventListener(\"pt0\",w),r?h(1):n.serviceWorker?n.serviceWorker.register(a+(o.swPath||\"partytown-sw.js\"),{scope:a}).then((function(t){t.active?h():t.installing&&t.installing.addEventListener(\"statechange\",(function(t){\"activated\"==t.target.state&&h()}))}),console.error):f())))}function h(t){c=e.createElement(t?\"script\":\"iframe\"),t||(c.setAttribute(\"style\",\"display:block;width:0;height:0;border:0;visibility:hidden\"),c.setAttribute(\"aria-hidden\",!0)),c.src=a+\"partytown-\"+(t?\"atomics.js?v=0.7.6\":\"sandbox-sw.html?\"+Date.now()),e.body.appendChild(c)}function f(n,r){for(w(),i==t&&(o.forward||[]).map((function(e){delete t[e.split(\".\")[0]]})),n=0;n<s.length;n++)(r=e.createElement(\"script\")).innerHTML=s[n].innerHTML,e.head.appendChild(r);c&&c.parentNode.removeChild(c)}function w(){clearTimeout(d)}o=t.partytown||{},i==t&&(o.forward||[]).map((function(e){p=t,e.split(\".\").map((function(e,n,i){p=p[i[n]]=n+1<i.length?\"push\"==i[n+1]?[]:p[i[n]]||{}:function(){(t._ptf=t._ptf||[]).push(i,arguments)}}))})),\"complete\"==e.readyState?u():(t.addEventListener(\"DOMContentLoaded\",u),t.addEventListener(\"load\",u))}(window,document,navigator,top,window.crossOriginIsolated);</script>","bodyTags":"<script type=\"text/javascript\" src=\"js/measure.js\" async=\"\"></script>","bodyTagsOpen":"","htmlAttrs":" lang=\"en\"","bodyAttrs":""};
